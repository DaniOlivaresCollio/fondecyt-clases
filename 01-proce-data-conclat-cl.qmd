...
Capítulo para el procesamiento de la Data Conclat Chile para generar los esquemas de clases. Datos actualizados para el 26/03/2026.
...
data <- readRDS("input/data/data-conclat-chile-EN.rds")
```

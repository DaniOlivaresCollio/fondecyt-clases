...
En el [tercero capítulo](03-proce-data-conclat-ar.html) se preparan los datos de Argentina generando las variables necesarias para armar los esquemas de clases, y en el [cuarto capítulo](04-esquemas-clases-ar.html) se arman diferentes esquemas de clases con los datos de Argentina.

En el [quinto capítulo](05-proc-marxism-clases-cl.html) se realiza la recodificación de algunas variables de interés para un capítulo de libro de Marxismo de Clases con los datos de Chile.

En el [sexto capítulo](06-graph-clases-cl.html) se presentan algunos gráficos útiles de los esquemas de clases con los datos de Chile.

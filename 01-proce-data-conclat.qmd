...
#### primera propuesta --> 1. employers: employers con 10 o más trabajadores
...
#### segunda propuesta --> 1. capitalists: employers 50 o más trabajadores
...
# Tabla de frecuencias ponderadas
wright_freq2 <- data_svy %>%
  group_by(wright_class2) %>%
  summarise(
    freq = survey_mean(vartype = NULL, na.rm = TRUE),
    n_unweighted = unweighted(n())
  ) %>%
...
con datos ponderados clases en adelante 

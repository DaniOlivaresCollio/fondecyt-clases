...
prom_por_clase %>%
  mutate(mean_income_fmt = label_number(prefix = "$", big.mark = ".")(mean_income))
...
prom_por_clase_w %>%
  mutate(mean_income_w_fmt = label_number(prefix = "$", big.mark = ".")(mean_income_w))

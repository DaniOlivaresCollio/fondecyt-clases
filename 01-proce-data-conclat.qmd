...
data <- data %>%
  ...
  set_variable_labels(wrightclass2_reduced3 = "Wright Class Typology Reduced + Informal (8)")
...
data <- data %>%
  ...
  set_variable_labels(age = "Income")
...
data <- data %>%
  ...
  set_variable_labels(age = "Income bracket")
...
```{r}
data$income_br_mean[data$income_br==1]  <- (           200000)             
data$income_br_mean[data$income_br==2]  <- ( 200001 +  400000) / 2        
data$income_br_mean[data$income_br==3]  <- ( 400001 +  600000) / 2      
data$income_br_mean[data$income_br==4]  <- ( 600001 +  800000) / 2       
data$income_br_mean[data$income_br==5]  <- ( 800001 + 1000000) / 2      
data$income_br_mean[data$income_br==6]  <- (1000001 + 1200000) / 2      
data$income_br_mean[data$income_br==7]  <- (1200001 + 1400000) / 2     
data$income_br_mean[data$income_br==8]  <- (1400001 + 1600000) / 2    
data$income_br_mean[data$income_br==9]  <- (1600001 + 1800000) / 2      
data$income_br_mean[data$income_br==10] <- (1800001 + 2000000) / 2    
data$income_br_mean[data$income_br==11] <- (2000001 + 2200000) / 2        
data$income_br_mean[data$income_br==12] <- (2200001 + 2400000) / 2        
data$income_br_mean[data$income_br==13] <- (2400001 + 2600000) / 2       
data$income_br_mean[data$income_br==14] <- (2600001 + 2800000) / 2      
data$income_br_mean[data$income_br==15] <- (2800001 + 3000000) / 2     
data$income_br_mean[data$income_br==16] <- (3000001) 
```

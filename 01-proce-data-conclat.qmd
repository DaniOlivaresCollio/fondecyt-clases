...
- primera propuesta --> 1. capitalists: employers con 10 o más trabajadores
...
data <- data %>%
  ...
  set_variable_labels(wright_class2 = "Wright Class Typology (2)")

frq(data$wright_class2)
```



- segunda propuesta --> 1. employers: employers 10 o más trabajadores
2. small employers: employers 1-9 trabajadores
3. petty bourgeoisie: solo self employed
4. expert managers: expert y manager
5. expert supervisor: expert y supervisor
6. experts: experts sin autoridad
7. skilled managers
8. skilled supervisors
9. skilled workers
10. nonskilled managers
...
a06 boletas
a10 incio actividades
a18 contrato escrito
